...
dashboard.section.buttons.val = {
  ...
  dashboard.button( "S", "  > Resume Session", ":SessionsLoad .nvim/.session<CR>"),
...
local quotes = {
  {"If you're not mortally embarrassed by the quality of your initial release, you've released too late", "", "-Reid Hoffman"},
  ...
  {'Iterateb the schedule with the code.', '', 'Use experience you gain as you implement to refine the project time scales.'},
